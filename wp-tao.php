...
if ( !class_exists( 'WP_Tracker_and_Optimizer' ) ) :
	...
	final class WP_Tracker_and_Optimizer {
		...
		private function constants() {
			...
			$this->define( 'WTBP_WPTAO_VERSION', '1.2.8.1' );   // Current version
		...
		private function load_textdomain() {
			...
			load_plugin_textdomain( WTBP_WPTAO_DOMAIN, false, $lang_dir );
		}
		...
		public function admin_notice_php() {
			...
			<div class="error">
				<p>
					<?php
					_e( 'WP Tao: You need PHP version at least 5.3 to run this plugin. You are currently using PHP version ', WTBP_WPTAO_DOMAIN );
					echo PHP_VERSION . '.';
					?>
				</p>
			</div>
