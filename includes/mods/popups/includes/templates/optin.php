			...
			<div class="wtbp-247p-optin-essence">
				...
				<?php if ( $this->options[ 'pp_visible' ] === 'show' && !empty( $this->options[ 'final_url' ] ) ): ?>
					...
					<div class="wtbp-247p-privacy-policy" >
						...
						<label for="wtbp-247p-privacy-agree"><?php printf( __( 'I agree to <a href="%s">privacy policy</a>', WTBP_WPTAO_DOMAIN ), esc_url( $this->options[ 'final_url' ] ) ); ?></label>
					</div>
	...
	<div class="wtbp-247p-optin">
		<form id="wtbp-247p-optin-form" class="wtbp-247p-popup-form" method="POST">	
			...
			<div class="wtbp-247p-optin-essence">
				...
				<input value="" class="wtbp-247p-email" type="text" name="email" placeholder="<?php _e( 'E-mail address', WTBP_WPTAO_DOMAIN ); ?>">
