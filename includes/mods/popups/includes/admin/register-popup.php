...
class WTBP_247P_Register_Popup {
	...
	public function add_custom_post_type() {
		...
		$args = array(
			'labels'			 => array(
				'name'				 => _x( 'WP Tao Popups', 'post type general name', WTBP_WPTAO_DOMAIN ),
				'singular_name'		 => _x( 'Popup', 'post type singular name', WTBP_WPTAO_DOMAIN ),
				'menu_name'			 => _x( 'Tao Popups', 'admin menu', WTBP_WPTAO_DOMAIN ),
				'name_admin_bar'	 => _x( 'Tao Popups', 'add new on admin bar', WTBP_WPTAO_DOMAIN ),
				'add_new'			 => _x( 'New Popup', 'popup', WTBP_WPTAO_DOMAIN ),
				'add_new_item'		 => __( 'Add new Popup', WTBP_WPTAO_DOMAIN ),
				'new_item'			 => __( 'New popup', WTBP_WPTAO_DOMAIN ),
				'edit_item'			 => __( 'Edit Popup', WTBP_WPTAO_DOMAIN ),
				'view_item'			 => __( 'View Popup', WTBP_WPTAO_DOMAIN ),
				'all_items'			 => __( 'Your Popups', WTBP_WPTAO_DOMAIN ),
				'search_items'		 => __( 'Search Popups', WTBP_WPTAO_DOMAIN ),
				'not_found'			 => __( 'No popups found.', WTBP_WPTAO_DOMAIN ),
				'not_found_in_trash' => __( 'No popups found in Trash.', WTBP_WPTAO_DOMAIN )
			),
			'show_ui'			 => true,
			'show_in_menu'		 => true,
	...
	public function register_metaboxes() {
		...
		add_meta_box( 'wtbp-247p-mb-customizer', __( 'Popup Customizer', WTBP_WPTAO_DOMAIN ), array( $this, 'metabox_customizer' ), WTBP_247P_POST_TYPE, 'normal' );
	}
	...
	public function metabox_sections() {
		...
		$sections = array(
			'logic'				 => __( 'Logic', WTBP_WPTAO_DOMAIN ),
			'appearance'		 => __( 'Apperiance', WTBP_WPTAO_DOMAIN ),
			'optin'				 => __( 'Opt-in (experimental)', WTBP_WPTAO_DOMAIN ),
			'email-confirmation' => __( 'E-mail confirmation', WTBP_WPTAO_DOMAIN ),
		);
	...
	public static function get_logic_scenarios() {
		...
		$scenarios = array(
			'247popup' => __( 'Custom', WTBP_WPTAO_DOMAIN )
		);
	...
	public static function get_options( $post_id ) {
		...
		$settings[ 'opt_submit_text' ]	 = isset( $o[ 'opt_submit_text' ] ) && !empty( $o[ 'opt_submit_text' ] ) ? sanitize_text_field( $o[ 'opt_submit_text' ] ) : __( 'Send', WTBP_WPTAO_DOMAIN );
