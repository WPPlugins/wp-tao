...
<div class="metabox metabox-247p-logic">
	...
	<h3><?php _e( 'Logic', WTBP_WPTAO_DOMAIN ); ?></h3>
	<?php if ( count( $this->get_logic_scenarios() ) > 1 ): ?>
		<div class="wtbp-247p-form-group">
			<label>
				<?php _e( 'Logic scenarios', WTBP_WPTAO_DOMAIN ); ?>
			</label>
	...
	<div class="metabox-247p-extend-247popup metabox-247p-extend-fields">
		<h4><?php _e( 'Restrictions', WTBP_WPTAO_DOMAIN ); ?></h4>

		<div class="wtbp-247p-form-group">
			<label>
				<?php _e( 'Show popup on', WTBP_WPTAO_DOMAIN ); ?>
			</label>
			<select name="rest_show_on">
				<option <?php selected( 'all', $opt[ 'rest_show_on' ] ); ?> value="all"><?php _e( 'All pages', WTBP_WPTAO_DOMAIN ); ?></option>
				<option <?php selected( 'custom', $opt[ 'rest_show_on' ] ); ?> value="custom"><?php _e( 'Custom rules', WTBP_WPTAO_DOMAIN ); ?></option>
			</select>
		</div>
		...
		<div class="wtbp-247p-custom-rules">
			...
			<div class="wtbp-247p-form-group">
				<label>
					<?php _e( 'Post types', WTBP_WPTAO_DOMAIN ); ?>
				</label>
			...
			<div class="wtbp-247p-form-group">
				<label>
					<?php _e( 'Other views', WTBP_WPTAO_DOMAIN ); ?>
				</label>
				<div class="wtbp-247p-rest-mg">
					...
					<label for="wtbp-247p-rest-cb-frontpage"><?php _e( 'Front page', WTBP_WPTAO_DOMAIN ); ?></label>
					<br />
					...
					<label for="wtbp-247p-rest-cb-archives"><?php _e( 'Archives', WTBP_WPTAO_DOMAIN ); ?></label>
					<br />
				</div>
			...
			<div class="wtbp-247p-form-group wtbp-247p-form-group-full">
				<label>
					<?php _e( 'URL containing keywords', WTBP_WPTAO_DOMAIN ); ?>
				</label>
				<p class="wtbp-247p-field-desc"><?php _e( 'Use commas to separate keywords', WTBP_WPTAO_DOMAIN ); ?></p>
	...
	<div class="metabox-247p-extend-247popup metabox-247p-extend-fields">
		...
		<h4><?php _e( 'Trigger popup on', WTBP_WPTAO_DOMAIN ); ?></h4>

		<div class="wtbp-247p-form-group">
			<label>
				<?php _e( 'Event', WTBP_WPTAO_DOMAIN ); ?>
			</label>
			<select name="trigg_event">
				<option <?php selected( 'after-load', $opt[ 'trigg_event' ] ); ?> value="after-load"><?php _e( 'After page load', WTBP_WPTAO_DOMAIN ); ?></option>
				<option <?php selected( 'after-scroll', $opt[ 'trigg_event' ] ); ?> value="after-scroll"><?php _e( 'After scroll down', WTBP_WPTAO_DOMAIN ); ?></option>
			</select>
		</div>

		<div class="wtbp-247p-form-group">
			<label for="trigg_timeout"> <?php _e( 'Timeout', WTBP_WPTAO_DOMAIN ); ?></label>
			<input name="trigg_timeout" 
				   class="small-text" 
				   type="number" 
				   value="<?php echo $opt[ 'trigg_timeout' ]; ?>" /> <?php _e( 'seconds', WTBP_WPTAO_DOMAIN ); ?>
		</div>
