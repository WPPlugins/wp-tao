...
class WTBP_WPTAO_Integration_WooCommerce {
	...
	public function different_currencies() {
		...
		<div class="error">
			<p>
				<?php
				printf( __( 'WP Tao: The WooCommerce currency (%s) is different from the WP Tao currency (%s). Make up your mind on one currency!', WTBP_WPTAO_DOMAIN ), $woo_currency, $tao_currency );
				?>
			</p>
		</div>
		<?php
