...
class WTBP_WPTAO_Integration_EED {
	...
	public function different_currencies() {
		...
		<div class="error">
			<p>
				<?php
				printf( __( 'WP Tao: The EDD currency (%s) is different from the WP Tao currency (%s). Make up your mind on one currency!', WTBP_WPTAO_DOMAIN ), $edd_currency, $tao_currency );
				?>
			</p>
		</div>
		<?php
