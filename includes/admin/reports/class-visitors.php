...
class WTBP_WPTAO_Admin_Report_Visitors extends WTBP_WPTAO_Admin_Reports {
	...
	function __construct() {
		...
		$this->report_name = __( 'Pageviews and visitors', WTBP_WPTAO_DOMAIN );
	...
	private function pageviews_widget() {
		...
		$args = array(
			...
			'category'		 => 'traffic',
			'priority'		 => 45,
			'title'			 => __( 'Pageviews', WTBP_WPTAO_DOMAIN ),
	...
	private function visitors_widget() {
		...
		$args = array(
			...
			'category'		 => 'traffic',
			'priority'		 => 46,
			'title'			 => __( 'Visitors', WTBP_WPTAO_DOMAIN ),
			'report_slug'	 => $this->report_slug, // Add link to a report
	...
	public function print_script() {
		...
		<script>
		    ...
		    function wptao_chart_pageviews() {
		        ...
		        data.addColumn( 'number', '<?php _e( 'Pageviews', WTBP_WPTAO_DOMAIN ); ?>' );
		...
		?>
		        ...
		        var options = {
		            title: '<?php printf( __( 'Pageviews ( %d )', WTBP_WPTAO_DOMAIN ), $this->total_pageviews ); ?>',
		            colors: [ '#00A0D2' ],
		        };
		    ...
		    function wptao_chart_visitors() {
		        ...
		        var data = new google.visualization.DataTable();
		        data.addColumn( 'date', '<?php _e( 'Date', WTBP_WPTAO_DOMAIN ); ?>' );
		        data.addColumn( 'number', '<?php _e( 'Visits', WTBP_WPTAO_DOMAIN ); ?>' );
		...
		?>
		        ...
		        var options = {
		            title: '<?php printf( __( 'Visits ( %d )', WTBP_WPTAO_DOMAIN ), $this->total_visits ); ?>',
		            colors: [ '#194552' ],
		        };
