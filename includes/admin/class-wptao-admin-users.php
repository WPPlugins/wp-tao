			...
			switch ( $action ) {
				...
				case 'update':
					...
					if ( !current_user_can( 'manage_options', $user_id ) ) {
						wp_die( __( 'You do not have permission to edit this user.', WTBP_WPTAO_DOMAIN ) );
					}
			...
			switch ( $action ) {
				...
				case 'actions':
					...
					if ( false != $delete_events ) {
						...
						$success .= __( 'The events and fingerprints of the record were successfully deleted.', WTBP_WPTAO_DOMAIN ) . '<br />';
					}
					...
					if ( false != $add_to_blacklist ) {
						...
						$success .= __( 'The record was successfully added to the blacklist.', WTBP_WPTAO_DOMAIN ) . '<br />';
						...
						$success .= __( 'The record was successfully removed from the blacklist.', WTBP_WPTAO_DOMAIN ) . '<br />';
						...
						$success .= __( 'The record was successfully deleted.', WTBP_WPTAO_DOMAIN ) . '<br />';
					}

					if ( empty( $success ) ) {
						$success = __( 'No action was performed.', WTBP_WPTAO_DOMAIN );
					}
