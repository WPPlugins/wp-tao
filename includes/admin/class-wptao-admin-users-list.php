...
class WTBP_WPTAO_Users_List_Table extends WP_List_Table {
	...
	function __construct() {
		...
		parent::__construct( array(
			'singular'	 => __( 'User', WTBP_WPTAO_DOMAIN ), //singular name of the listed records
			'plural'	 => __( 'Users', WTBP_WPTAO_DOMAIN ), //plural name of the listed records
	...
	public function get_columns() {
		$users_columns = array(
			...
			'user_avatar'	 => '',
			'username'		 => __( 'Name', WTBP_WPTAO_DOMAIN ),
			'email'			 => __( 'Email', WTBP_WPTAO_DOMAIN ),
			'phone'			 => __( 'Phone', WTBP_WPTAO_DOMAIN ),
			'created_ts'	 => __( 'Created', WTBP_WPTAO_DOMAIN ),
			'last_active'	 => __( 'Last Active', WTBP_WPTAO_DOMAIN )
		);
	...
	public function column_username( $item ) {
		...
		$actions = array(
			'wptao-profile'	 => sprintf( '<a href="?page=%s&action=%s&user=%s">%s</a>', $_REQUEST[ 'page' ], 'wptao-profile', $item[ 'id' ], __( 'Show profile', WTBP_WPTAO_DOMAIN ) ),
			'edit'			 => sprintf( '<a href="?page=%s&action=%s&user=%s">%s</a>', $_REQUEST[ 'page' ], 'edit', $item[ 'id' ], __( 'Edit', WTBP_WPTAO_DOMAIN ) ),
			'actions'		 => sprintf( '<a href="?page=%s&action=%s&user=%s">%s</a>', $_REQUEST[ 'page' ], 'actions', $item[ 'id' ], __( 'Actions', WTBP_WPTAO_DOMAIN ) )
		);
	...
	public function column_created_ts( $item ) {
		if ( empty( $item[ 'created_ts' ] ) ) {
			return __( 'No data', WTBP_WPTAO_DOMAIN );
		}
	...
	public function column_last_active( $item ) {
		...
		$time_diff = sprintf( _x( '%s ago', '%s = human-readable time difference', WTBP_WPTAO_DOMAIN ), human_time_diff( $item[ 'last_active_ts' ] ) );
...
//    }
	...
	public function no_items() {
		_e( 'No users found.', WTBP_WPTAO_DOMAIN );
	}
