	...
	class WTBP_WPTAO_Admin_Menus {
		...
		public function admin_menu() {
			...
			if ( current_user_can( 'view_wptao_reports' ) ) {
				add_menu_page( __( 'WP Tao', WTBP_WPTAO_DOMAIN ), __( 'WP Tao', WTBP_WPTAO_DOMAIN ), 'view_wptao_reports', 'wtbp-wptao', array( $this, 'dashboard_page' ), WTBP_WPTAO_URL . '/assets/images/wptao-ico-16.png', '50' );
			}

			add_submenu_page( 'wtbp-wptao', __( 'Dashboard', WTBP_WPTAO_DOMAIN ), __( 'Dashboard', WTBP_WPTAO_DOMAIN ), 'manage_options', 'wtbp-wptao', array( $this, 'dashboard_page' ) );
		}
		...
		public function users_menu() {
			...
			add_submenu_page( 'wtbp-wptao', __( 'Identified', WTBP_WPTAO_DOMAIN ), __( 'Identified', WTBP_WPTAO_DOMAIN ), 'view_wptao_reports', 'wtbp-wptao-users', array( $this, 'users_page' ) );
		}
		...
		public function events_menu() {
			...
			add_submenu_page( 'wtbp-wptao', __( 'Events', WTBP_WPTAO_DOMAIN ), __( 'Events', WTBP_WPTAO_DOMAIN ), 'view_wptao_reports', 'wtbp-wptao-events', array( $this, 'events_page' ) );
		}
		...
		public function settings_menu() {
			...
			add_submenu_page( 'wtbp-wptao', __( 'WP Tao Settings', WTBP_WPTAO_DOMAIN ), __( 'Settings', WTBP_WPTAO_DOMAIN ), 'manage_options', 'wtbp-wptao-settings', array( $this, 'settings_page' ) );
		}
		...
		public function upgrades_menu() {
			...
			add_submenu_page( null, __( 'WP Tao Upgrades', WTBP_WPTAO_DOMAIN ), __( 'WP Tao Upgrades', WTBP_WPTAO_DOMAIN ), 'manage_options', 'wtbp-wptao-upgrades', array( $this, 'upgrades_page' ) );
		}
		...
		public function addons_menu() {
			...
			$submenu[ 'wtbp-wptao' ][] = array( '<span style="color:#f39c12;">' . __( 'Addons', WTBP_WPTAO_DOMAIN ) . '</span> <span class="update-plugins count-' . $pend_count . '"><span class="plugin-count">' . $pend_count . '</span></span>', 'manage_options', $url, __( 'Addons', WTBP_WPTAO_DOMAIN ), $class );
		}
