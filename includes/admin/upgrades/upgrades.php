...
?>
<div class="wrap">
	<h2><?php _e( 'WP Tao - Upgrades', WTBP_WPTAO_DOMAIN ); ?></h2>
...
<?php if ( !empty( $action ) ) : ?>
		...
		<div id="edd-upgrade-status">
			<p>
		<?php _e( 'The upgrade process has started, please be patient. This could take several minutes. You will be automatically redirected when the upgrade is finished.', WTBP_WPTAO_DOMAIN ); ?>
...
<?php else : ?>
		...
		<div id="wptao-upgrade-status">
			<p>
		<?php _e( 'There is nothing to upgrade!', WTBP_WPTAO_DOMAIN ); ?>
			</p>
		</div>
		<script type="text/javascript">
			setTimeout( function () {
