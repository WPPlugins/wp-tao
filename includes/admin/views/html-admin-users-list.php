...
<div class="wrap wptao-users-list-wrap">
	...
	<div class="wptao-dashboard-head">
		<h2><span class="dashicons dashicons-admin-users"></span><?php _e( 'WP TAO Identified', WTBP_WPTAO_DOMAIN ); ?></h2>
	</div>

    <form method="get">

		<?php $wptao_users_list->search_box( __( 'Search Identified', WTBP_WPTAO_DOMAIN ), 'search_id' ); ?>
