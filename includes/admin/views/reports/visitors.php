	...
	<table class="wp-list-table widefat fixed striped pages">
		<thead>
			<tr>
				...
				<th class="manage-column" scope="col"><?php _e( 'Visits', WTBP_WPTAO_DOMAIN ) ?></th>
			</tr>
		</thead>
			...
			<?php if ( !empty( $this->days ) ): ?>
				...
				foreach ( $this->days as $day ):
					...
					<tr class="" id="">
						...
						<td data-colname="<?php _e( 'Pageviews', WTBP_WPTAO_DOMAIN ) ?>" class="wptao-cell-number"><?php echo array_key_exists( $day, $this->data ) ? absint( $this->data[ $day ][ 'pageviews' ] ) : 0; ?></td>
						<td data-colname="<?php _e( 'Visits', WTBP_WPTAO_DOMAIN ) ?>" class="wptao-cell-number"><?php echo array_key_exists( $day, $this->data ) ? absint( $this->data[ $day ][ 'visits' ] ) : 0; ?></td>
					</tr>
					<?php
					$i++;
				endforeach;
