	...
	<table class="wp-list-table widefat fixed striped pages">
		<thead>
			<tr>
				...
				<th class="manage-column wptao-column-date" scope="col"><?php _e( 'User', WTBP_WPTAO_DOMAIN ) ?></th>
				<th class="manage-column" scope="col"><?php printf( __( 'Amount [%s]', WTBP_WPTAO_DOMAIN ), WTBP_WPTAO_Helpers::get_currency_symbol( $wptao_settings[ 'currency' ] ) ) ?></th>
			...
			<?php if ( !empty( $this->data ) ): ?>
				...
				foreach ( $this->data as $v ):
					...
					<tr>
						...
						<td data-colname="<?php _e( 'User', WTBP_WPTAO_DOMAIN ) ?>"><b><?php
								if ( !empty( $v[ 'user_id' ] ) ) {
									...
									_e( 'Unidentified users', WTBP_WPTAO_DOMAIN );
								}
								?></b></td>
						<td data-colname="<?php printf( __( 'Amount [%s]', WTBP_WPTAO_DOMAIN ), WTBP_WPTAO_Helpers::get_currency_symbol( $wptao_settings[ 'currency' ] ) ); ?>" class="wptao-cell-number"><?php echo WTBP_WPTAO_Helpers::amount_format( $v[ 'amount' ], '' ); ?></td>
