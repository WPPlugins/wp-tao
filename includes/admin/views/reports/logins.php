...
<div class="wptao-report-summary wptao-row">
	<div class="wptao-report-summary-item wptao-success-color wptao-report-summary-col6">
		<h4><?php _e( 'Successful login', WTBP_WPTAO_DOMAIN ); ?></h4>
	...
	<div class="wptao-report-summary-item wptao-error-color wptao-report-summary-col6">
		<h4><?php _e( 'Failed login', WTBP_WPTAO_DOMAIN ); ?></h4>
	...
	<table class="wp-list-table widefat fixed striped pages">
		<thead>
			<tr>
				...
				<th class="manage-column" scope="col"><?php _e( 'Successful login', WTBP_WPTAO_DOMAIN ) ?></th>
				<th class="manage-column" scope="col"><?php _e( 'Failed login', WTBP_WPTAO_DOMAIN ) ?></th>
			</tr>
		</thead>
			...
			<?php if ( !empty( $this->days ) ): ?>
				...
				foreach ( $this->days as $day ):
					...
					<tr class="" id="">
						...
						<td data-colname="<?php _e( 'Successful login', WTBP_WPTAO_DOMAIN ) ?>" class="wptao-cell-number"><?php echo array_key_exists( $day, $this->data ) && isset( $this->data[ $day ][ 'success_logins' ] ) ? absint( $this->data[ $day ][ 'success_logins' ] ) : 0; ?></td>
						<td data-colname="<?php _e( 'Failed login', WTBP_WPTAO_DOMAIN ) ?>" class="wptao-cell-number"><?php echo array_key_exists( $day, $this->data ) && isset( $this->data[ $day ][ 'failed_logins' ] ) ? absint( $this->data[ $day ][ 'failed_logins' ] ) : 0; ?></td>
					</tr>
					<?php
					$i++;
				endforeach;
