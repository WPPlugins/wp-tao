	...
	<table class="wp-list-table widefat fixed striped pages">
		<thead>
			<tr>
				...
				<th class="manage-column" scope="col"><?php _e( 'Contacts', WTBP_WPTAO_DOMAIN ) ?></th>
			</tr>
		</thead>
			...
			<?php if ( !empty( $this->days ) ): ?>
				...
				foreach ( $this->days as $day ):
					...
					<tr>
						...
						<td data-colname="<?php _e( 'Contacts', WTBP_WPTAO_DOMAIN ) ?>" class="wptao-cell-number"><?php echo array_key_exists( $day, $this->data ) ? absint( $this->data[ $day ][ 'contacts' ] ) : 0; ?></td>
					</tr>
					<?php
					$i++;
				endforeach;
