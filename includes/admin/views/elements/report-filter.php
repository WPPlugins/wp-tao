	...
	<div class="wptao-report-filter">
		...
		<form class="wptao-row" method="POST" action="<?php echo esc_url( $this->report_url ); ?>">
			...
			<?php if ( in_array( 'limit', $this->options[ 'filters' ] ) ): ?>
				...
				<div class="wptao-report-items-limit" title="<?php _e( 'Number of records:', WTBP_WPTAO_DOMAIN ); ?>">
					...
					<div class="wptao-filter-expanded">
						<div class="wptao-filter-expanded-inner">
							<div class="wptao-date-exp-label"><?php _e( 'Number of records:', WTBP_WPTAO_DOMAIN ); ?></div>
							<div class="wptao-ril-inputs-wrapp">
								...
								<input type="submit" value="<?php _e( 'Sort', WTBP_WPTAO_DOMAIN ); ?>" class="button button-primary">
							</div>
						</div>
					</div>
				</div>
