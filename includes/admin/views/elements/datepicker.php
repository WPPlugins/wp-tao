...
<div class="wptao-datepicker">
	<div class="wptao-report-filter-button wptao-date-button" role="button" aria-expanded="true">
		...
		<div class="wptao-date-btn-inner">
			...
			switch ( $dr ) {
				case 'today':
					_e( 'Today', WTBP_WPTAO_DOMAIN );
					break;
				case 'c_month':
					_e( 'Current month', WTBP_WPTAO_DOMAIN );
					break;
				case 'yesterday':
					_e( 'Yesterday', WTBP_WPTAO_DOMAIN );
					break;
				case 'l_month':
					_e( 'Last month', WTBP_WPTAO_DOMAIN );
					break;
				case 'all':
					_e( 'All time', WTBP_WPTAO_DOMAIN );
					break;
				case '7_days':
					_e( 'Last 7 days', WTBP_WPTAO_DOMAIN );
					break;
				case '30_days':
					_e( 'Last 30 days', WTBP_WPTAO_DOMAIN );
					break;
				case 'custom':
		...
		<div class="wptao-filter-expanded-inner">
			<div>
				<div class="wptao-date-qd-wrapp">
					<div class="wptao-date-exp-label"><?php _e( 'Quick dates', WTBP_WPTAO_DOMAIN ); ?></div>
							...
							<tbody>
								<tr>
									<td>
										...
										?>"><?php printf( __( 'Today: %s', WTBP_WPTAO_DOMAIN ), $args[ 'quick_dates' ][ 'today' ][ 'human_format' ] ); ?>
										</a>
									</td>
									<td>
										<a class="wptao-date-qd-link" href="<?php
										...
										?>"><?php printf( __( 'Current month: %s', WTBP_WPTAO_DOMAIN ), $args[ 'quick_dates' ][ 'current_month' ][ 'human_format' ] ); ?>
										</a>
									</td>
								</tr>
								<tr>
									<td>
										...
										?>"><?php printf( __( 'Yesterday: %s', WTBP_WPTAO_DOMAIN ), $args[ 'quick_dates' ][ 'yesterday' ][ 'human_format' ] ); ?>
										</a>
									</td>
									<td>
										<a class="wptao-date-qd-link" href="<?php
										...
										?>"><?php printf( __( 'Last month: %s', WTBP_WPTAO_DOMAIN ), $args[ 'quick_dates' ][ 'last_month' ][ 'human_format' ] ); ?>
										</a>
									</td>
								</tr>
								<tr>
									<td>
										...
										?>"><?php _e( 'Last 7 days', WTBP_WPTAO_DOMAIN ); ?>
										</a>
									</td>
									<td>
										<a class="wptao-date-qd-link" href="<?php
										...
										?>"><?php _e( 'All time', WTBP_WPTAO_DOMAIN ); ?>
										</a>
									</td>
								</tr>
								<tr>
									<td>
										...
										?>"><?php _e( 'Last 30 days', WTBP_WPTAO_DOMAIN ); ?>
										</a>
									</td>
									<td>&nbsp;</td>
								</tr>
				...
				<div class="wptao-date-range-wrapp">
					<div class="wptao-date-exp-label"><?php _e( 'Date Range', WTBP_WPTAO_DOMAIN ); ?></div>
