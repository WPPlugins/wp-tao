...
<div class="metabox-prefs" id="screen-meta">
	...
	<div aria-label="<?php _e( 'Screen options', WTBP_WPTAO_DOMAIN ); ?>" tabindex="-1" class="hidden" id="screen-options-wrap">
		<form method="post" action="<?php echo admin_url( 'admin.php?page=wtbp-wptao' ); ?>" id="adv-settings">
			<fieldset class="screen_options">
				<legend><?php _e( 'Espresso reports', WTBP_WPTAO_DOMAIN ); ?></legend>
			...
			<p class="submit">
				<input type="submit" value="<?php _e( 'Apply', WTBP_WPTAO_DOMAIN ); ?>" class="button button-primary" id="wptao-screen-options-apply" name="wptao-screen-options-apply">
			</p>
