...
class WTBP_WPTAO_Events extends WTBP_WPTAO_DB {
	...
	public function events_categories() {
		$types = array(
			'contact'	 => __( 'Contact', WTBP_WPTAO_DOMAIN ),
			'traffic'	 => __( 'Traffic', WTBP_WPTAO_DOMAIN ),
			'commerce'	 => __( 'Commerce', WTBP_WPTAO_DOMAIN ),
			'user'		 => __( 'User', WTBP_WPTAO_DOMAIN ),
		);
	...
	public function events_actions() {
		$actions = array(
			'pageview'			 => apply_filters( 'wptao_pageview_actions', array(
				...
				'category'	 => 'traffic',
				'tags'		 => array(),
				'title'		 => __( 'Visit page', WTBP_WPTAO_DOMAIN ),
				'style'		 => array(
					'color'	 => '#2A97D7',
			...
			'exit_intent'	 => apply_filters( 'wptao_exit_intent_actions', array(
				...
				'category'	 => 'traffic',
				'tags'		 => array(),
				'title'		 => __( 'Exit intent', WTBP_WPTAO_DOMAIN ),
				'style'		 => array(
					'color'	 => '#2A97D7',
			...
			'login'				 => apply_filters( 'wptao_login_actions', array(
				...
				'category'	 => 'user',
				'tags'		 => array(),
				'title'		 => __( 'Login', WTBP_WPTAO_DOMAIN ),
			...
			'register'			 => apply_filters( 'wptao_register_actions', array(
				...
				'category'	 => 'user',
				'tags'		 => array(),
				'title'		 => __( 'Register', WTBP_WPTAO_DOMAIN ),
				'style'		 => array(
					'color'	 => '#28ACA3',
					'icon'	 => 'dashicons-admin-users'
				)
			...
			'comment'			 => apply_filters( 'wptao_comment_actions', array(
				...
				'category'	 => 'user',
				'tags'		 => array(),
				'title'		 => __( 'Comment', WTBP_WPTAO_DOMAIN ),
				'style'		 => array(
					'color'	 => '#A24A92',
					'icon'	 => 'dashicons-edit'
				)
			...
			'identified'		 => apply_filters( 'wptao_identified_actions', array(
				...
				'category'	 => 'user',
				'tags'		 => array(),
				'title'		 => __( 'User identified', WTBP_WPTAO_DOMAIN ),
				'style'		 => array(
					'color'	 => '#fcc914',
					'icon'	 => 'dashicons-yes'
				)
			...
			'order'				 => apply_filters( 'wptao_order_actions', array(
				...
				'category'	 => 'commerce',
				'tags'		 => array(),
				'title'		 => __( 'New order', WTBP_WPTAO_DOMAIN ),
				'style'		 => array(
					'color'	 => '#F36959',
					'icon'	 => 'dashicons-cart'
				)
			...
			'payment'			 => apply_filters( 'wptao_payment_actions', array(
				...
				'category'	 => 'commerce',
				'tags'		 => array(),
				'title'		 => __( 'Payment', WTBP_WPTAO_DOMAIN ),
				'style'		 => array(
					'color'	 => '#F36959',
			...
			'add_to_cart'		 => apply_filters( 'wptao_add_to_cart_actions', array(
				...
				'category'	 => 'commerce',
				'tags'		 => array(),
				'title'		 => __( 'Add to cart', WTBP_WPTAO_DOMAIN ),
				'style'		 => array(
					'color'	 => '#F36959',
					'icon'	 => 'dashicons-cart'
				)
			...
			'remove_from_cart'	 => apply_filters( 'wptao_remove_from_cart_actions', array(
				...
				'category'	 => 'commerce',
				'tags'		 => array(),
				'title'		 => __( 'Remove from cart', WTBP_WPTAO_DOMAIN ),
				'style'		 => array(
					'color'	 => '#F36959',
					'icon'	 => 'dashicons-cart'
				)
	...
	public function localize_admin_scripts( $hook ) {
		...
		if ( isset( $_GET[ 'page' ] ) && ($_GET[ 'page' ] === 'wtbp-wptao-users' || $_GET[ 'page' ] === 'wtbp-wptao-events' ) ) {
			...
			$vars[ 'confirm_message' ]	 = __( 'Are you sure that you want to permanently delete this event?', WTBP_WPTAO_DOMAIN );
