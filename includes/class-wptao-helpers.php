...
class WTBP_WPTAO_Helpers {
	...
	public static function get_currencies() {
		$currencies = array(
			'USD'	 => __( 'US Dollars (&#36;)', WTBP_WPTAO_DOMAIN ),
			'EUR'	 => __( 'Euros (&euro;)', WTBP_WPTAO_DOMAIN ),
			'GBP'	 => __( 'Pounds Sterling (&pound;)', WTBP_WPTAO_DOMAIN ),
			'AUD'	 => __( 'Australian Dollars (&#36;)', WTBP_WPTAO_DOMAIN ),
			'BRL'	 => __( 'Brazilian Real (R&#36;)', WTBP_WPTAO_DOMAIN ),
			'CAD'	 => __( 'Canadian Dollars (&#36;)', WTBP_WPTAO_DOMAIN ),
			'CZK'	 => __( 'Czech Koruna', WTBP_WPTAO_DOMAIN ),
			'DKK'	 => __( 'Danish Krone', WTBP_WPTAO_DOMAIN ),
			'HKD'	 => __( 'Hong Kong Dollar (&#36;)', WTBP_WPTAO_DOMAIN ),
			'HUF'	 => __( 'Hungarian Forint', WTBP_WPTAO_DOMAIN ),
			'ILS'	 => __( 'Israeli Shekel (&#8362;)', WTBP_WPTAO_DOMAIN ),
			'JPY'	 => __( 'Japanese Yen (&yen;)', WTBP_WPTAO_DOMAIN ),
			'MYR'	 => __( 'Malaysian Ringgits', WTBP_WPTAO_DOMAIN ),
			'MXN'	 => __( 'Mexican Peso (&#36;)', WTBP_WPTAO_DOMAIN ),
			'NZD'	 => __( 'New Zealand Dollar (&#36;)', WTBP_WPTAO_DOMAIN ),
			'NOK'	 => __( 'Norwegian Krone', WTBP_WPTAO_DOMAIN ),
			'PHP'	 => __( 'Philippine Pesos', WTBP_WPTAO_DOMAIN ),
			'PLN'	 => __( 'Polish Zloty', WTBP_WPTAO_DOMAIN ),
			'SGD'	 => __( 'Singapore Dollar (&#36;)', WTBP_WPTAO_DOMAIN ),
			'SEK'	 => __( 'Swedish Krona', WTBP_WPTAO_DOMAIN ),
			'CHF'	 => __( 'Swiss Franc', WTBP_WPTAO_DOMAIN ),
			'TWD'	 => __( 'Taiwan New Dollars', WTBP_WPTAO_DOMAIN ),
			'THB'	 => __( 'Thai Baht (&#3647;)', WTBP_WPTAO_DOMAIN ),
			'INR'	 => __( 'Indian Rupee (&#8377;)', WTBP_WPTAO_DOMAIN ),
			'TRY'	 => __( 'Turkish Lira (&#8378;)', WTBP_WPTAO_DOMAIN ),
			'RIAL'	 => __( 'Iranian Rial (&#65020;)', WTBP_WPTAO_DOMAIN ),
			'RUB'	 => __( 'Russian Rubles', WTBP_WPTAO_DOMAIN ),
			'ZAR'	 => __( 'South African Rand', WTBP_WPTAO_DOMAIN ),
			'AED'	 => __( 'United Arab Emirates dirham', WTBP_WPTAO_DOMAIN )
		);
	...
	public static function datepicker_i18() {
		...
		$args = array(
			'close_text'		 => __( 'Done', WTBP_WPTAO_DOMAIN ),
			'current_text'		 => __( 'Today', WTBP_WPTAO_DOMAIN ),
			'month_names'		 => array_values( (array) $wp_locale->month ),
			'month_names_short'	 => array_values( (array) $wp_locale->month_abbrev ),
			'month_status'		 => __( 'Show a different month', WTBP_WPTAO_DOMAIN ),
	...
	public static function get_storage_time_options() {
		$storage_time_options = array(
			'3'		 => __( '3 days', WTBP_WPTAO_DOMAIN ),
			'7'		 => __( '7 days', WTBP_WPTAO_DOMAIN ),
			'30'	 => __( '30 days', WTBP_WPTAO_DOMAIN ),
			'90'	 => __( '90 days', WTBP_WPTAO_DOMAIN ),
			'180'	 => __( '180 days', WTBP_WPTAO_DOMAIN ),
			'365'	 => __( '365 days', WTBP_WPTAO_DOMAIN ),
		);
	...
	/*
	 * Get wptao.org url depending on user language
	 * 
	 * @param $target
	 *
	 * @return string URL
