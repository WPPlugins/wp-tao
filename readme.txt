...
No additional resources or external services needed. Just install and activate the plugin and start gathering data! Check [user guide](http://wptao.org/documentation/user-guide/?utm_source=wordpress_org&utm_medium=webpage&utm_campaign=readme) for more information.
...
* endless possibilities with extensions. Check [developers guide](http://wptao.org/documentation/developers-guide/?utm_source=wordpress_org&utm_medium=webpage&utm_campaign=readme) for more information.
...
= Extensions =
WP Tao is already packed with features, but if you still need more, our free and premium add-ons allow you to extend the plugin's functionality even further! To check the addons out, visit our official site at [wptao.org/addons](http://wptao.org/addons/developers-guide/?utm_source=wordpress_org&utm_medium=webpage&utm_campaign=readme).

= Popular extensions =

* [WP Tao Recover Lost Sales](http://wptao.org/addons/wp-tao-recover-lost-sales/?utm_source=wordpress_org&utm_medium=webpage&utm_campaign=readme) - helps to automate the recovery of abandoned shopping carts
* [WP Tao MailChimp](http://wptao.org/addons/wp-tao-mailchimp/?utm_source=wordpress_org&utm_medium=webpage&utm_campaign=readme), [WP Tao GetResponse](http://wptao.org/addons/wp-tao-getresponse/?utm_source=wordpress_org&utm_medium=webpage&utm_campaign=readme) - give you ablility to identify visitors of your website faster and monitor sale results for particular mailing campaigns

= Feedback =
Have an idea for a new integration or feature? We’d love to hear your suggestions.
Feel free to contact us using the contact form available on the website:
[http://wptao.org](http://wptao.org/?utm_source=wordpress_org&utm_medium=webpage&utm_campaign=readme)
